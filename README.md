...
4. [`¿Qué es una Key Pair?`](docs/01-conceptos-previos.md#4-qué-es-una-key-pair)
5. [`¿Qué es SSH y cómo funciona el sistema de llaves?`](docs/01-conceptos-previos.md#5-qué-es-ssh-y-cómo-funciona-el-sistema-de-llaves)
6. [`¿Qué es un Security Group?`](docs/01-conceptos-previos.md#6-qué-es-un-security-group)
